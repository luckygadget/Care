...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiException> bhandleBadRequest(BadRequestException ex){
    ...
    public ResponseEntity<ApiException> handleMisMatchType(MethodArgumentTypeMismatchException ex){
         ApiException error  = new ApiException("Invalid parameter type: "+ex.getMessage(), HttpStatus.BAD_REQUEST, "TYPE_MISMATCH");
